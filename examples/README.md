...
| **OT3** Gated/Fused | matmul_gelu, rmsnorm_residual, silu_and_mul, geglu, rope, cross_entropy, fused_linear_cross_entropy, quantize/dequantize | `05_matmul_gelu.ak`, `19_silu_and_mul.ak`, ... |
