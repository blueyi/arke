...
EMBEDDING = _register(OpSchema(name="embedding", category="move",
    ...
    template_hint=TemplateHint(template_name="embedding", extra_ctx={"op_variant":"embedding"}),
...
PERMUTE = _register(OpSchema(name="permute", category="move",
    ...
    template_hint=TemplateHint(template_name="permute", extra_ctx={"op_variant":"permute","dims":[0,2,1,3]}),
...
COPY = _register(OpSchema(name="copy_", category="move",
    ...
    shape_rule=ShapeRule(kind="same_as_input", input_key="X"),
    template_hint=TemplateHint(template_name="transpose", extra_ctx={"op_variant":"copy_"}),
