...
> **Purpose:** G6.6 — Map every SemanticIR/StrategyIR field to its MLIR dialect op/attribute counterpart, enabling future Stage 3 MLIR backend.
...
## 6. Stage 3 Implementation Plan

When Stage 3 adds the MLIR backend (`arke/backend/mlir_backend.py`):
...
*Generated by Arke toolchain — Stage 1, Phase 1.9 (G6.6)*
