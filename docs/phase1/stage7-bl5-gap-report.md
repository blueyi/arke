...
- **L1 ops with Stage 7 track6 results:** 36
- **L1 op coverage ratio:** 0.8000
- **L1 required shapes total:** 685
- **L1 required shapes observed:** 36
- **L1 shape coverage ratio:** 0.0526
