...
from benchmarks.stage7_dashboard import build_stage7_dashboard
...
def test_build_stage7_dashboard_combines_gap_audit_and_status_slices(tmp_path: Path):
    ...
    dashboard = build_stage7_dashboard(
    ...
    assert dashboard["focus"]["l2"]["perf_field_gaps"] == [
        {"op": "qkv_fa", "missing_perf_target_fields": ["perf_gap"]}
    ]
