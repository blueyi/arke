...
- `docs/design/stage1/e2e-flow.md` — Full optimization flow (Phase 1→4)
- `docs/design/stage1/benchmark-design.md` — BL/OT/ST/L benchmark framework
...
→ Full catalog: `docs/design/stage1/benchmark/benchmark-ops.md`
